...
        <div
          className="hero-bg"
          style={{ backgroundImage: "url(/assets/brand/hero_home.png)" }}
        />
...
            <button className="btn primary" onClick={() => go("/puppies")}>
              Available Puppies
            </button>
            <button className="btn" onClick={() => go("/breedings")}>
              Breedings
            </button>
...
              Bold Heart Bullies currently has no owned studs standing at this time.
              All studs referenced on this website are outside studs used for past,
              confirmed, or planned breedings and are not owned by Bold Heart Bullies.
            </p>
          </div>
        </div>
      </div>
...
        <div>{brand.name} — {brand.location}</div>
        <div>
